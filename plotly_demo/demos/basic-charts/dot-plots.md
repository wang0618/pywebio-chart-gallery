...
Dot plots (also known as [Cleveland dot plots](<https://en.wikipedia.org/wiki/Dot_plot_(statistics)>)) show changes between two (or more) points in time or between two (or more) conditions. Compared to a [bar chart](https://plotly.com/python/bar-charts/), dot plots can be less cluttered and allow for an easier comparison between conditions.
...
<div>
            ...
            <div id="75006977-ddcc-4d55-9186-8d8d1bbe411e" class="plotly-graph-div" style="height:100%; width:100%;"></div>
            <script type="text/javascript">
                require(["plotly"], function(Plotly) {
                    window.PLOTLYENV=window.PLOTLYENV || {};
                    
                if (document.getElementById("75006977-ddcc-4d55-9186-8d8d1bbe411e")) {
                    Plotly.newPlot(
                        '75006977-ddcc-4d55-9186-8d8d1bbe411e',
                        [{"hovertemplate": "gender=Men<br>Annual Salary (in thousands)=%{x}<br>school=%{y}<extra></extra>", "legendgroup": "Men", "marker": {"color": "#636efa", "symbol": "circle"}, "mode": "markers", "name": "Men", "showlegend": true, "type": "scatter", "x": [72, 67, 73, 80, 76, 79, 84, 78, 86, 93, 94, 90, 92, 96, 94, 112], "xaxis": "x", "y": ["Brown", "NYU", "Notre Dame", "Cornell", "Tufts", "Yale", "Dartmouth", "Chicago", "Columbia", "Duke", "Georgetown", "Princeton", "U.Penn", "Stanford", "MIT", "Harvard"], "yaxis": "y"}, {"hovertemplate": "gender=Women<br>Annual Salary (in thousands)=%{x}<br>school=%{y}<extra></extra>", "legendgroup": "Women", "marker": {"color": "#EF553B", "symbol": "circle"}, "mode": "markers", "name": "Women", "showlegend": true, "type": "scatter", "x": [92, 94, 100, 107, 112, 114, 114, 118, 119, 124, 131, 137, 141, 151, 152, 165], "xaxis": "x", "y": ["Brown", "NYU", "Notre Dame", "Cornell", "Tufts", "Yale", "Dartmouth", "Chicago", "Columbia", "Duke", "Georgetown", "Princeton", "U.Penn", "Stanford", "MIT", "Harvard"], "yaxis": "y"}],
...
<div>
            ...
            <div id="85697157-a7cb-4f19-9168-6a17bd28ef56" class="plotly-graph-div" style="height:100%; width:100%;"></div>
            <script type="text/javascript">
                require(["plotly"], function(Plotly) {
                    window.PLOTLYENV=window.PLOTLYENV || {};
                    
                if (document.getElementById("85697157-a7cb-4f19-9168-6a17bd28ef56")) {
                    Plotly.newPlot(
                        '85697157-a7cb-4f19-9168-6a17bd28ef56',
                        [{"marker": {"color": "crimson", "size": 12}, "mode": "markers", "name": "Women", "type": "scatter", "x": [72, 67, 73, 80, 76, 79, 84, 78, 86, 93, 94, 90, 92, 96, 94, 112], "y": ["Brown", "NYU", "Notre Dame", "Cornell", "Tufts", "Yale", "Dartmouth", "Chicago", "Columbia", "Duke", "Georgetown", "Princeton", "U.Penn", "Stanford", "MIT", "Harvard"]}, {"marker": {"color": "gold", "size": 12}, "mode": "markers", "name": "Men", "type": "scatter", "x": [92, 94, 100, 107, 112, 114, 114, 118, 119, 124, 131, 137, 141, 151, 152, 165], "y": ["Brown", "NYU", "Notre Dame", "Cornell", "Tufts", "Yale", "Dartmouth", "Chicago", "Columbia", "Duke", "Georgetown", "Princeton", "U.Penn", "Stanford", "MIT", "Harvard"]}],
...
<div>
            ...
            <div id="7fa1da13-5f87-4077-9355-b99162338dca" class="plotly-graph-div" style="height:600px; width:800px;"></div>
            <script type="text/javascript">
                require(["plotly"], function(Plotly) {
                    window.PLOTLYENV=window.PLOTLYENV || {};
                    
                if (document.getElementById("7fa1da13-5f87-4077-9355-b99162338dca")) {
                    Plotly.newPlot(
                        '7fa1da13-5f87-4077-9355-b99162338dca',
